...
char* Snake::changeMap(){ // 맵바꾸기
	switch(level){
		case 1: return setMaptoList(map1); break;
		case 2: return setMaptoList(map2); break;
		case 3: return setMaptoList(map3); break;
		case 4: return setMaptoList(map4); break;
		case 5: return setMaptoList(map5); break;
	}
}
